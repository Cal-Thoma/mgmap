...
blastp -query fasta.fasta -db ww_proteins.faa -outfmt 6 -max_target_seqs num_sequences > /input/fasta_ww_blast.out # enter the max number of sequences you wish to retrieve: num_sequences, enter the fasta file: fasta.file, and change the name of your output file fasta_ww_blast.out
cd ..
```
